...
module.exports = {
    mocha: describe('Creating a challenge', async function () {
        ...
        testHelper.createNockResponse("POST", '/challenge', {userId: 180}, 200, testHelper.createChallengeNockResp);
        testHelper.createNockResponse("PUT", '/challenge/activate', {userId: 180}, 200, testHelper.createChallengeNockResp);
        ...
        it('should return the created challenge successfully', async function () {
            await challengesController.createChallenge({params, session, body: {challenge: testHelper.createChallengeReqBody}}, new testHelper.pseudoRes(async function (resp) {
