...
module.exports = {
    mocha: describe('Finding a single set of challenge balances', async function () {
        const session = testHelper.testSession;
        const params = {challengeId: 4};
        testHelper.createNockResponse("GET", "/challenge/balances", {userId: 180, challengeId: 4}, 200, testHelper.findAllBalancesForChallengeNockResp);
